...
class Connection():
    ...
    def call(self, method, url, params=None, stream=False, files=None):
        ...
        # If HMAC
            ...
            for retry in range(10):
                ...
                signature = hmac_lib.new(self.hmac_secret, msg=message.encode('utf-8'), digestmod=hashlib.sha256).hexdigest().upper()
    ...
    def _set_hmac(self, server, hmac_key, hmac_secret):
        ...
        self.hmac_secret = bytes(hmac_secret, encoding='utf-8')
