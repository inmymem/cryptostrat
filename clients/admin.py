...
class ClientAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('total_sell_volume','total_buy_volume','sumsub_token_active', 'sumsub_verification_link')
    #readonly_fields
    ...
    fieldsets = (
        ('Profile', {
            'fields': (
                ...
                ('name_match_checked', 'id_verified', 'liveness_verified', 'address_verified', 'video_verified', 'source_of_funds_verified',),
...
class TransactionAdmin(admin.ModelAdmin):
    list_display = ('platform', 'client', 'status')
